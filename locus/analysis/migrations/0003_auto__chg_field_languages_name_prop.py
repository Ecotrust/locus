...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Languages.name_prop'
        db.alter_column('analysis_languages', 'name_prop', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))


    def backwards(self, orm):
        
        # Changing field 'Languages.name_prop'
        db.alter_column('analysis_languages', 'name_prop', self.gf('django.db.models.fields.CharField')(max_length=40))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SeaRise3m'
        db.create_table('analysis_searise3m', (
        ...
        db.send_create_signal('analysis', ['SeaRise3m'])

        # Adding model 'SeaRise6m'
        db.create_table('analysis_searise6m', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gridcode', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=54009, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['SeaRise6m'])

        # Adding model 'SeaRise1m'
        db.create_table('analysis_searise1m', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gridcode', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=54009, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['SeaRise1m'])


    def backwards(self, orm):
        
        # Deleting model 'SeaRise3m'
        db.delete_table('analysis_searise3m')

        # Deleting model 'SeaRise6m'
        db.delete_table('analysis_searise6m')

        # Deleting model 'SeaRise1m'
        db.delete_table('analysis_searise1m')

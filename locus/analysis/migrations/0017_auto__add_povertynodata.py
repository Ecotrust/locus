...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PovertyNoData'
        db.create_table('analysis_povertynodata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area_sqkm', self.gf('django.db.models.fields.FloatField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=54009, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['PovertyNoData'])


    def backwards(self, orm):
        
        # Deleting model 'PovertyNoData'
        db.delete_table('analysis_povertynodata')

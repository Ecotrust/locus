...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ReportCache.date_created'
        db.add_column('analysis_reportcache', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 8, 12), blank=True), keep_default=False)

        # Adding field 'ReportCache.date_modified'
        db.add_column('analysis_reportcache', 'date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 8, 12), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ReportCache.date_created'
        db.delete_column('analysis_reportcache', 'date_created')

        # Deleting field 'ReportCache.date_modified'
        db.delete_column('analysis_reportcache', 'date_modified')

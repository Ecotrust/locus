...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Language.name_prop'
        db.alter_column('analysis_language', 'name_prop', self.gf('django.db.models.fields.CharField')(max_length=225, null=True))

        # Changing field 'Language.nam_label'
        db.alter_column('analysis_language', 'nam_label', self.gf('django.db.models.fields.CharField')(max_length=225))

        # Changing field 'Language.name2'
        db.alter_column('analysis_language', 'name2', self.gf('django.db.models.fields.CharField')(max_length=225, null=True))

        # Changing field 'Language.nam_ansi'
        db.alter_column('analysis_language', 'nam_ansi', self.gf('django.db.models.fields.CharField')(max_length=225, null=True))

    def backwards(self, orm):

        # Changing field 'Language.name_prop'
        db.alter_column('analysis_language', 'name_prop', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Language.nam_label'
        db.alter_column('analysis_language', 'nam_label', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'Language.name2'
        db.alter_column('analysis_language', 'name2', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Language.nam_ansi'
        db.alter_column('analysis_language', 'nam_ansi', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
    ...
    models = {
        ...
        'analysis.extinctlanguages': {
            ...
            'nam_ansi': ('django.db.models.fields.CharField', [], {'max_length': '225'}),
            'nam_label': ('django.db.models.fields.CharField', [], {'max_length': '225'}),
            'name2': ('django.db.models.fields.CharField', [], {'max_length': '225'}),
            'name_prop': ('django.db.models.fields.CharField', [], {'max_length': '225'}),
        ...
        'analysis.language': {
            ...
            'lmp_pop1': ('django.db.models.fields.FloatField', [], {}),
            'nam_ansi': ('django.db.models.fields.CharField', [], {'max_length': '225', 'null': 'True', 'blank': 'True'}),
            'nam_label': ('django.db.models.fields.CharField', [], {'max_length': '225'}),
            'name2': ('django.db.models.fields.CharField', [], {'max_length': '225', 'null': 'True', 'blank': 'True'}),
            'name_prop': ('django.db.models.fields.CharField', [], {'max_length': '225', 'null': 'True', 'blank': 'True'}),
            'pop': ('django.db.models.fields.CharField', [], {'max_length': '86', 'null': 'True', 'blank': 'True'})
        },
        'analysis.lastwild': {

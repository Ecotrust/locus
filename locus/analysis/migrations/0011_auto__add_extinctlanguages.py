...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ExtinctLanguages'
        db.create_table('analysis_extinctlanguages', (
            ...
            ('g', self.gf('django.db.models.fields.CharField')(max_length=225)),
            ('lmp_lon', self.gf('django.db.models.fields.FloatField')()),
            ('lmp_lat', self.gf('django.db.models.fields.FloatField')()),
            ('lmp_c1', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=54009, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['ExtinctLanguages'])


    def backwards(self, orm):
        
        # Deleting model 'ExtinctLanguages'
        db.delete_table('analysis_extinctlanguages')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Watersheds'
        db.create_table('analysis_watersheds', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('maj_bas', self.gf('django.db.models.fields.IntegerField')()),
            ('maj_name', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('maj_area', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=54009, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['Watersheds'])


    def backwards(self, orm):
        
        # Deleting model 'Watersheds'
        db.delete_table('analysis_watersheds')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtinctLanguages.name_prop'
        db.alter_column('analysis_extinctlanguages', 'name_prop', self.gf('django.db.models.fields.CharField')(max_length=225))

        # Changing field 'ExtinctLanguages.nam_label'
        db.alter_column('analysis_extinctlanguages', 'nam_label', self.gf('django.db.models.fields.CharField')(max_length=225))

        # Changing field 'ExtinctLanguages.name2'
        db.alter_column('analysis_extinctlanguages', 'name2', self.gf('django.db.models.fields.CharField')(max_length=225))

        # Changing field 'ExtinctLanguages.nam_ansi'
        db.alter_column('analysis_extinctlanguages', 'nam_ansi', self.gf('django.db.models.fields.CharField')(max_length=225))

    def backwards(self, orm):

        # Changing field 'ExtinctLanguages.name_prop'
        db.alter_column('analysis_extinctlanguages', 'name_prop', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'ExtinctLanguages.nam_label'
        db.alter_column('analysis_extinctlanguages', 'nam_label', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'ExtinctLanguages.name2'
        db.alter_column('analysis_extinctlanguages', 'name2', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'ExtinctLanguages.nam_ansi'
        db.alter_column('analysis_extinctlanguages', 'nam_ansi', self.gf('django.db.models.fields.CharField')(max_length=40))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UrbanExtent'
        db.create_table('analysis_urbanextent', (
        ...
        db.send_create_signal('analysis', ['UrbanExtent'])


    def backwards(self, orm):
        
        # Deleting model 'UrbanExtent'
        db.delete_table('analysis_urbanextent')

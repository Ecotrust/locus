...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WorldMask'
        db.create_table('analysis_worldmask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dissme', self.gf('django.db.models.fields.IntegerField')()),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=54009, null=True, blank=True)),
        ))
        db.send_create_signal('analysis', ['WorldMask'])


    def backwards(self, orm):
        
        # Deleting model 'WorldMask'
        db.delete_table('analysis_worldmask')

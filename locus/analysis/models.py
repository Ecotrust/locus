...
class Language(models.Model):
    ...
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Spoken Langauges")
...
class EcoRegions(models.Model):
    ...
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="WWF Eco-Regions")
    objects = models.GeoManager()  
...
class MarineRegions(models.Model):
    ...
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Marine Eco-Regions")
    objects = models.GeoManager()    
...
class LastWild(models.Model):
    ...
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Last of the Wild")
    objects = models.GeoManager()    
...
class Watersheds(models.Model):
    ...
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Major Watersheds")
    objects = models.GeoManager()    
    
class WorldMask(models.Model):
    dissme = models.IntegerField()
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="World Terrestrial Mask")
    objects = models.GeoManager()    
...
class ExtinctLanguages(models.Model):
    ...
    geometry = models.PointField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Extinct Language Points")
    objects = models.GeoManager()   

class SeaRise1m(models.Model):
    gridcode = models.IntegerField()
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Sea Level Rise 1m")
    objects = models.GeoManager()    

class SeaRise3m(models.Model):
    gridcode = models.IntegerField()
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Sea Level Rise 3m")
    objects = models.GeoManager()    

class SeaRise6m(models.Model):
    gridcode = models.IntegerField()
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Sea Level Rise 6m")
    objects = models.GeoManager()       

class UrbanExtent(models.Model):
    gridcode = models.IntegerField()
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Urban Extent Boundaries")
    objects = models.GeoManager()    
    
class PovertyNoData(models.Model):
    area_sqkm = models.FloatField()
    geometry = models.MultiPolygonField(srid=settings.REPORT_VECTOR_SRID, null=True, blank=True, verbose_name="Areas Lacking Poverty Data")
    objects = models.GeoManager()
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ThiessenPolygon'
        db.create_table('fbapp_thiessenpolygon', (
            ('base_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=900913)),
        ))
        db.send_create_signal('fbapp', ['ThiessenPolygon'])

        # Adding field 'GeneratedBioregion.thiessen'
        db.add_column('fbapp_generatedbioregion', 'thiessen',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fbapp.ThiessenPolygon'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ThiessenPolygon'
        db.delete_table('fbapp_thiessenpolygon')

        # Deleting field 'GeneratedBioregion.thiessen'
        db.delete_column('fbapp_generatedbioregion', 'thiessen_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fbapp_storypoint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source_type', self.gf('django.db.models.fields.CharField')(default='user', max_length=30)),
            ('source_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('source_link', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=900913)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('flagged', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('flag_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('fbapp', ['StoryPoint'])


    def backwards(self, orm):
        # Deleting model 'StoryPoint'
        db.delete_table('fbapp_storypoint')
